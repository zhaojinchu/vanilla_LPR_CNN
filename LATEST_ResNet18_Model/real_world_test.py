...
# ---------------------------------------------------
# 4) Model Definition
#    (Same as your LicensePlateDetector class)
# ---------------------------------------------------
...
def main():
    # ------------ Config -------------
    image_dir = "C:/Users/Zhaojin/OneDrive/Desktop/vanilla_LPR_CNN/real_life_data"  # CHANGE ME
